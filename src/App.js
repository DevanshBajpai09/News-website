      ...
      <div>
        <BrowserRouter>
          ...
          <Route exact path="/technology" element={<News key="technology" pageSize={20} country='in' category='technology'/>}></Route> */}
            ...
            <Route exact path="/" element={<News setProgress={setProgress} apiKey={apiKey} key="general" pageSize={20} country='in' category='top' />}></Route>
            ...
            <Route exact path="/general" element={<News setProgress={setProgress} apiKey={apiKey} key="general" pageSize={20} country='in' category='top' />}></Route>
